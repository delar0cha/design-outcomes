...
// Illustration "recipe" per post — consumed by the Illustration component.
// kind: one of 'bars', 'grid', 'wedge', 'stack', 'spiral', 'rays', 'blocks', 'type'
// palette: 3 hex values (bg, mid, ink)
const ill = (kind, palette, seed=1) => ({ kind, palette, seed });

window.POSTS = [
  {
    slug: 'structure-not-the-person',
    cat: 'decision',
    audience: 'Leaders',
    date: '2026-04-10',
    ...
    why: 'Because the symptoms of a structural problem and a performance problem look nearly identical from a distance.',
    read: '5 min',
    illustration: ill('blocks', ['#E8DECB','#2F4858','#15120E'], 2),
    body: [
  ...
  {
    slug: 'verbosity-in-interviews',
    cat: 'crit',
    audience: 'Leaders',
    date: '2026-04-12',
    title: 'What Verbosity in an Interview Actually Tells You',
    excerpt: 'A candidate gave strong answers with real substance. Every single one took twice as long as it needed to.',
    why: 'Because naming a pattern honestly without reducing someone to a single data point is the real skill in hiring.',
    read: '5 min',
    illustration: ill('bars', ['#EDE5D3','#4A5D3A','#15120E'], 3),
    body: [
      ...
      {type:'p', text:`The broader lesson for design leaders who participate in hiring outside their direct function: your job in those interviews is not just to fill out the scorecard. It is to give your hiring partner a usable, honest read that helps them make a better decision. That means naming the pattern, naming what it might cost, and naming what it might mean for development, all in language that protects the candidate from being unfairly reduced to a single observation.`},
    ],
  },

  {
    slug: 'building-cheap-carrying-expensive',
    cat: 'reframe',
    audience: 'Everyone',
    date: '2026-04-15',
    title: 'When Building Gets Cheap, Carrying Gets Expensive',
    excerpt: 'AI is making it faster and easier to ship features. The hard part is deciding what deserves to exist.',
    why: 'Because design leadership becomes more valuable, not less, when execution gets cheap.',
    read: '5 min',
    illustration: ill('wedge', ['#EADFCF','#B8432B','#15120E'], 4),
    body: [
      ...
      {type:'p', text:`This is where design leadership becomes most valuable, and most misunderstood. Our role has always been to advocate for coherence over accumulation. We are the ones who are supposed to ask whether this thing deserves to exist, whether it earns its complexity, whether it makes the product simpler or just more capable. That question has always been important. In an environment where building is nearly free, it becomes the most important question in the room.`},
...

  {
    ...
    excerpt: 'I built a portfolio site for my design leadership work using Claude Design, Claude Code, and Vercel. No Figma. No CMS. No manual coding.',
    why: 'Because the barrier to sharing your work just dropped to almost zero.',
    read: '6 min',
    illustration: ill('type', ['#EADFCF','#8A5A2B','#15120E'], 8),
    body: [
      ...
      {type:'p', text:`Claude (the conversational AI) walked me through every single one of these issues in real time, diagnosing errors from screenshots I shared and giving me the exact commands to run. That experience — pasting a screenshot of a terminal error and getting back the precise fix in seconds — is the part that felt genuinely new. I was pair-programming with an AI, not on code, but on infrastructure.`},
...
window.FEATURED_SLUGS = [
  ...
  'building-cheap-carrying-expensive',
  'verbosity-in-interviews',
  'structure-not-the-person',
];
