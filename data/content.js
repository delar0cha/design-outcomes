...
window.POSTS = [
  ...
  { slug:'the-feedback-that-stopped', cat:'crit', audience:'Leaders', date:'2026-04-19',
    ...
    excerpt:'When a teammate goes silent, it is rarely maturity. It is almost always withdrawal. Here is what that looks like, why it is more dangerous than open conflict, and the bounded repair that got two designers back in a room with each other.',
    ...
    read:'4 min',
    illustration: { kind:'photo', src:'/images/the-feedback-that-stopped.jpg' },
    body: [
      {type:'p', text:'When a teammate stops giving you feedback, it is almost never because they do not care. It is because they have cared and been met with defensiveness enough times that the return on caring has collapsed to zero. Feedback culture dies quietly, one withdrawn conversation at a time.'},
      {type:'p', text:'I\u2019ve seen this more than a handful of times as a manager. One recent example took place over the course of a few months. A senior designer had been offering thoughtful critique to a peer working on an adjacent surface. Her feedback was good. It was specific, it was kind, and it was grounded in the work. Over time, it was absorbed but not acted on, reframed as something easier to address, or deflected with a reason. Eventually she made a decision she did not share out loud. She stopped giving it.'},
      {type:'p', text:'When she finally named the pattern to me, her language was the thing I could not let go of. \u201CI stopped because it felt disrespectful to keep trying.\u201D'},
      {type:'h', text:'Two failure modes'},
      {type:'p', text:'There are two failure modes in a feedback culture. The loud one is conflict, where people are giving critique badly or taking it personally in visible ways. Everyone sees it. Managers get called in. The team notices. You can address it because you can see it.'},
      {type:'p', text:'The other failure mode is withdrawal, where people simply stop offering what they used to offer, and the absence gets misread as harmony. Withdrawal is more dangerous because it is invisible until the work starts to suffer enough to register. By the time you notice, trust has already eroded on both sides. The person who stopped giving feedback is carrying a quiet resentment. The person who stopped receiving it has lost a thinking partner they may not have known they had.'},
      {type:'h', text:'What I saw in the work'},
      {type:'p', text:'The designer on the receiving end of the withdrawal was shipping, but with blind spots that a five-minute crit would have caught. Decisions that needed a second set of eyes were going out without them. He was not aware anything had changed, because the absence of feedback is invisible from the inside. He had been told his work was fine. Fine was what came back.'},
      {type:'p', text:'The senior designer, meanwhile, was carrying the emotional tax of the choice she had made. She was more reserved in team reviews. She declined optional collaboration sessions. The rest of the team picked up on the shift without knowing what it was, and the pillar\u2019s feedback culture as a whole grew more muted.'},
      {type:'h', text:'The repair'},
      {type:'p', text:'The conversations I had to run were with both designers separately, and the repair path had to be specific enough to be safe to step into.'},
      {type:'p', text:'For the designer who had stopped receiving feedback well, the coaching was concrete. Acknowledge before explaining. Thank before pushing back. Show the change in the next review if one is coming. Treat feedback like a signal, not an opinion to defend against.'},
      {type:'p', text:'For the designer who had stopped giving feedback, the agreement was bounded. She would re-engage for a defined window on specific surfaces, with a check-in at the end of it rather than an open-ended commitment. The bounded structure gave her something safer to step back into than a vague promise to try again.'},
      {type:'h', text:'What to watch for'},
      {type:'quote', text:'If your team has become notably reserved with each other, do not celebrate it as maturity. Get curious about what they have stopped saying.'},
      {type:'p', text:'If you are a manager and your team has become notably reserved with each other, do not celebrate it as maturity. Get curious about what they have stopped saying. Ask the senior ICs what feedback they used to give that they are not giving anymore. Ask the receivers how often they hear from their peers in crit compared to six months ago. Silence is not the same as agreement.'},
      {type:'p', text:'Most feedback advice is about how to give it well. This is the advice nobody writes down. When feedback has already stopped, the recovery is not a relaunch of your feedback culture. It is a small enough first step that the people involved can re-engage without having to relitigate everything that led them to quit in the first place.'},
    ],
  },
